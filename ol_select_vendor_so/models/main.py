        ...
        for i in self.order_line:
            ...
            if len(product.seller_ids) == 0:
                ...
                if choosen_vendor!="":
                    ...
                    temp3 = {
                        "name_1": i.vendor_id.id,
                        "product_uom_1": i.product_uom.id,
                        "price_1": 0.00,
                        "delay_1": 1
                    }
                    ...
                    min_sup_id.name = temp3['name_1']
                    min_sup_id.product_uom = temp3['product_uom_1']
                    min_sup_id.price = temp3['price_1']
                    min_sup_id.delay = temp3['delay_1']
                #     line.seller_ids = [(0, 0,  {
                #         "name": line.name,
